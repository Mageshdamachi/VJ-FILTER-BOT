...
ʀᴇғᴇʀᴀʟ ʟɪɴᴋ - https://telegram.me/{}?start=Mw1-{}
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/movies_worldda1/3)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
ஏய் <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 நீங்கள் தூங்கும் போதே பணம் சம்பாதிக்கும் வழியை
கண்டுபிடிக்கவில்லை என்றால்,
நீங்கள் இறக்கும் வரை வேலை செய்துகொண்டே இருப்பீர்கள்.
— வாரன் பஃபெ """
...
നിങ്ങൾ ഉറങ്ങുമ്പോൾ തന്നെ പണം സമ്പാദിക്കുന്ന വഴിയെ
കണ്ടെത്തുന്നില്ലെങ്കിൽ,
നിങ്ങൾ മരിക്കുന്നതു വരെ ജോലി ചെയ്യേണ്ടിവരും.
— വോറൻ ബഫറ്റ് """
